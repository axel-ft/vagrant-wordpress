...
iptables -A INPUT -i ${guest_interface_name} -p tcp --sport 22 -d ${squid_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT      # SSH authorized hosts
iptables -A INPUT -i ${guest_interface_name} -p tcp --sport 22 -d ${haproxy_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT    # SSH authorized hosts
iptables -A INPUT -i ${guest_interface_name} -p tcp --sport 22 -d ${mariadb_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT    # SSH authorized hosts
iptables -A INPUT -i ${guest_interface_name} -p tcp --sport 22 -d ${rsyslog_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT    # SSH authorized hosts
...
iptables -A INPUT -i ${guest_interface_name} -p tcp --dport 22 -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT
...
iptables -A OUTPUT -o ${guest_interface_name} -p tcp --dport 22 -d ${squid_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT      # SSH authorized hosts
iptables -A OUTPUT -o ${guest_interface_name} -p tcp --dport 22 -d ${haproxy_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT    # SSH authorized hosts
iptables -A OUTPUT -o ${guest_interface_name} -p tcp --dport 22 -d ${mariadb_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT    # SSH authorized hosts
iptables -A OUTPUT -o ${guest_interface_name} -p tcp --dport 22 -d ${rsyslog_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT    # SSH authorized hosts
...
iptables -A OUTPUT -o ${guest_interface_name} -p tcp --sport 22 -m conntrack --ctstate ESTABLISHED -j ACCEPT
