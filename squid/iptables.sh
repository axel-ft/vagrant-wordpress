...
iptables -A INPUT -i ${bridgeif_guest_name} -p tcp --dport 3128 -s ${centreon_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT # Proxy authorized hosts
...
iptables -A INPUT -i ${bridgeif_guest_name} -p tcp --dport 3128 -s ${openvpn_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT # Proxy authorized hosts
...
iptables -A OUTPUT -o ${bridgeif_guest_name} -p tcp --dport 514 -d ${rsyslog_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT # Established TCP Rsyslog
iptables -A OUTPUT -o ${bridgeif_guest_name} -p udp --dport 514 -d ${rsyslog_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT # Established UDP Rsyslog
...
iptables -A OUTPUT -o ${bridgeif_guest_name} -p tcp --sport 3128 -d ${centreon_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT   # Proxy authorized hosts
...
iptables -A OUTPUT -o ${bridgeif_guest_name} -p tcp --sport 3128 -d ${openvpn_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT   # Proxy authorized hosts
