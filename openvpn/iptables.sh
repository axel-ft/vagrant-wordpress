...
iptables -A INPUT -i ${bridgeif_guest_name} -p udp --dport 1194 -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT          # OpenVPN
...
iptables -A OUTPUT -o ${bridgeif_guest_name} -p udp --sport 1194 -m conntrack --ctstate ESTABLISHED -j ACCEPT          # OpenVPN
