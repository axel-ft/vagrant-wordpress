...
iptables -A INPUT -i ${guest_interface_name} -p tcp --dport 514 -s ${openvpn_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT # Rsyslog authorized hosts
iptables -A INPUT -i ${guest_interface_name} -p tcp --dport 514 -s ${cockpit_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT # Rsyslog authorized hosts
...
iptables -A INPUT -i ${guest_interface_name} -p udp --dport 514 -s ${openvpn_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT # Rsyslog authorized hosts
iptables -A INPUT -i ${guest_interface_name} -p udp --dport 514 -s ${cockpit_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT # Rsyslog authorized hosts
...
iptables -A OUTPUT -o ${guest_interface_name} -p tcp --sport 514 -d ${openvpn_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT   # Rsyslog authorized hosts
iptables -A OUTPUT -o ${guest_interface_name} -p tcp --sport 514 -d ${cockpit_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT   # Rsyslog authorized hosts
...
iptables -A OUTPUT -o ${guest_interface_name} -p udp --sport 514 -d ${openvpn_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT    # Rsyslog authorized hosts
iptables -A OUTPUT -o ${guest_interface_name} -p udp --sport 514 -d ${cockpit_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT    # Rsyslog authorized hosts
