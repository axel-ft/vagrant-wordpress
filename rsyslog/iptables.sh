...
iptables -A INPUT -i ${bridgeif_guest_name} -p tcp --dport 514 -s ${openvpn_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT # Rsyslog authorized hosts
...
iptables -A INPUT -i ${bridgeif_guest_name} -p udp --dport 514 -s ${haproxy_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT # Rsyslog authorized hosts
iptables -A INPUT -i ${bridgeif_guest_name} -p udp --dport 514 -s ${mariadb_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT # Rsyslog authorized hosts
...
iptables -A INPUT -i ${bridgeif_guest_name} -p udp --dport 514 -s ${openvpn_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT # Rsyslog authorized hosts
...
iptables -A INPUT -i ${bridgeif_guest_name} -p tcp --sport 9200 -s ${elk_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT        # Filebeat output to Elasticsearch
...
iptables -A OUTPUT -o ${bridgeif_guest_name} -p tcp --sport 514 -d ${openvpn_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT   # Rsyslog authorized hosts
...
iptables -A OUTPUT -o ${bridgeif_guest_name} -p udp --sport 514 -d ${haproxy_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT    # Rsyslog authorized hosts
iptables -A OUTPUT -o ${bridgeif_guest_name} -p udp --sport 514 -d ${mariadb_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT    # Rsyslog authorized hosts
...
iptables -A OUTPUT -o ${bridgeif_guest_name} -p udp --sport 514 -d ${openvpn_hostname} -m conntrack --ctstate ESTABLISHED -j ACCEPT    # Rsyslog authorized hosts
...
iptables -A OUTPUT -o ${bridgeif_guest_name} -p tcp --dport 9200 -d ${elk_hostname} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT   # Filebeat output to Elasticsearch
